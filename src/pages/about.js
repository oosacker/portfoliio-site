    ...
    return (
        <MDBContainer>
              ...
              <ul>
                  ...
                  <li>The hosting is provided by <a href="http://heroku.com">Heroku</a> while the domain name is managed by <a href="http://hover.com">Hover</a>. Connecting 2 separate services wasn't so simple, especially with Heroku's dyno system that doesn't provide a static IP address (which can be used for an A-Record). To do this, DNS targets (CNAME record) had to be generated on Heroku and configured on Hover's DNS settings. You may not know this, but the "root" address (http://natsuki.co.nz) and "www" address (http://www.natsuki.co.nz) is not the same thing!</li>
              </ul>
        </MDBContainer>
    );
}
