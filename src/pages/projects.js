        ...
        <MDBContainer>
            ...
            <MDBRow >
                ...
                <ProjectCard 
                    ...
                    ModalBody={["A simple full-stack web app I built with Express.js and React so that I could learn how to connect Node.js to React and expose/consume APIs. It allows you to check the weather in the selected city using the OpenWeatherMap public API.",<br/>,<br/>,"The Express.js server first reads the list of countries from a JSON file and exposes an API to the React frontend, so the country selection box can be populated. The selected country is then sent back to the server, and a JSON file of all known cities is read and filtered by the selected country. This city is then used to fetch the desired data from OpenWeatherMap. The list of cities had to be filtered i this way because it was far too large, causing performance issues and errors."]}
