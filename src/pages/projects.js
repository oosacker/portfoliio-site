        ...
        <MDBContainer>
            ...
            <MDBRow >
                ...
                <ProjectCard 
                    ...
                    ModalBody={["One of the first projects I worked on during my internship at Signify Limited. Due to the Covid-19 lockdown between March and April 2020, Signify staff began working from home. To keep everyone updated, the company decided to hold daily standups on Zoom.",<br/>,<br/>,"To aid this, a simple web app was built using the Silverstripe CMS to display staff schedules. A project manager can login to the backend interface and enter staff names and their daily activities for a whole work week. The user interface was built using a Silverstripe theme based on Bootstrap.",<br/>,<br/>,"This app became a favourite at Signify, and it is still being used at the company during their (now) in-person standups.",<br/>,<br/>,"As this is not a personal project, no link or source code is available."]}
                    ModalURL=""
