        ...
        <MDBContainer>
            ...
            <MDBRow left >
                ...
                <ProjectCard 
                    ...
                    ModalBody="A simple full-stack web app I built with Express.js and React so that I could learn how to connect Node.js to React and expose/consume APIs. 
                    It allows you to check the weather in the selected city using the OpenWeatherMap public API. The Express.js server first reads the list of countries from a JSON file and exposes an API to the React frontend, so the country selection box can be populated. 
                    The selected country is then sent back to the server, and a JSON file of all known cities is read and filtered by the selected country. This city is then used to fetch the desired data from OpenWeatherMap. The list of cities had to be filtered like this because it was far too large and caused errors."
                ...
                <ProjectCard 
                    ...
                    ModalBody="This was the first web app I ever made. During the course SWEN502, we learnt HTML, CSS, JavaScript and PHP all within 2 weeks (very tough!!!), and were asked to make a website using all of them. I investigated CSS grids and realised they could be used to create a simple game, and this was how this app came to be. I was pretty good with OOP/arrays in Java, so writing a game in JavaScript was not too hard. PHP was used for uploading the background images and sending emails. I got an A+."
                ...
                <ProjectCard 
                    ...
                    ModalBody="This was a industrial group project for SWEN503. The project involved working with UX design students from the Wellington ICT Graduate School, and our client was The Story Mint. The task was to implement a proprietary Python-based text analysis API onto a web app. This involved learning Python and a web framework (Flask), setting up a SQL database server, creating the user interface to match the UX design and displaying the analysis results. Note that the project is under NDA, so the code and web app cannot be shown. One of the major difficultites of the project was communicating with the UX design students, as they would keep to their own schedule. We however managed to get an A+."
                    ModalURL=""
                ...
                <ProjectCard 
                    ...
                    ModalBody="This was a group project for the course SWEN502. The requirement was to create a web app for customers to design their own customised pizza for a pizza restaurant, as well as an in-store desktop app for tracking the orders. I was in charge of designing the SQL database and the backend for the desktop app in Java, as well as improving the JavaFX user interface. No online link is available. We got an A."
                    ModalURL=""
                ...
                <ProjectCard 
                    ...
                    ModalBody="During SWEN502 we learned Android development for one week. The final assignment was to create a fully working web browser. The browser has go forward/backward buttons, as well as bookmarking and history functions. This was one of the most difficult assignments of the course, as we were asked to implement functions we had not learnt in class. Also, there were some issues about compatibility. Many students were upset with their grade. Mine was fine, as I knew I had to keep the Android API level low in Android Studio. I got an A+."
                    ModalURL=""
