        ...
        <MDBContainer>
            ...
            <MDBRow >
                ...
                <ProjectCard 
                    ...
                    image="./images/project_img/small/time2.png"
                    ModalHeader="Signify Time"
                    ModalBody={["A single-page web app that displays New Zealand's time and date as measured by an atomic clock, built during my internship at Signify Limited. ",<br/>,<br/>,"Data from the time server (attached to a caesium atomic clock) at the Measurement Standards Laboratory of New Zealand (MSL) is used as the source of time. It displays the time according to this time server, Signify's web server and the user's browser, as well as measured time differences between them.",<br/>,<br/>,"The Network Time Protocol (NTP) is used to correct for network delays to improve accuracy in the time measurement. The backend system was built in Express.js by a senior developer at Signify, and I was in charge of building the frontend with React. The design was made to look similar to Signify's homepage to also serve as an advertisement for the company.",<br/>,<br/>,"As this is not a personal project, its source code is not available. The link will be added shortly, when the app goes live."]}
                    ModalURL=""
                    ModalImage="./images/project_img/large/time2.png"
                    ModalGitHub={""}
                />
                ...
                <ProjectCard 
                    ...
                    ModalBody={["One of the first projects I worked on during my internship at Signify Limited. Due to the Covid-19 lockdown between March and April 2020, Signify staff began working from home. To keep everyone updated, the company decided to hold daily standups on Zoom.",<br/>,<br/>,"To aid this, a simple web app was built using the Silverstripe CMS to display staff schedules. It allows a project manager to login to the backend interface and enter staff names and their daily activities for a whole work week. The user interface was built using a Silverstripe theme based on Bootstrap.",<br/>,<br/>,"This app became a favourite at Signify, and it is still being used at the company during their (now) in-person standups.",<br/>,<br/>,"As this is not a personal project, no link or source code is available."]}
                    ModalURL=""
